...
function my_wpb_wl_hook_quickview_content(){
	...
	<div id="wpb_wl_quick_view_<?php echo get_the_id(); ?>" class="mfp-hide mfp-with-anim wpb_wl_quick_view_content wpb_wl_clearfix product">
		...
		<div class="wpb_wl_summary">
			...
			<!-- Product cart link -->
			<div class="my_button_cart">
			<?php woocommerce_template_loop_add_to_cart();?>
			</div>
			
			<div class="my_yith_wishlist">
			<!-- Wishlist Yith -->
			<?php 			
			$yith_wishlist = new YITH_WCWL_Frontend();
			$yith_wishlist->print_button();
			?>
			</div>
